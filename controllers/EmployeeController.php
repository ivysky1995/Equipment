...
class EmployeeController extends Controller
{
    ...
    /*
     * Add action create-lending-history
     * 
     */
    public function actionCreateLendingHistory(){
        $lendingHistory = new \app\models\LendingHistory();
        
        if ($lendingHistory->load(Yii::$app->request->post())){
            
            $model = LendingHistory::findOne(['employee_id'=>$lendingHistory->employee_id,'equipment_id'=>$lendingHistory->equipment_id]);
            if (!$model){
//                 $model->lending_date = time();
